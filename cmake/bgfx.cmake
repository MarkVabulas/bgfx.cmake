...
if (DEFINED BGFX_CONFIG_DEBUG_OBJECT_NAME)
	if(BGFX_CONFIG_DEBUG_OBJECT_NAME)
		target_compile_definitions( bgfx PRIVATE BGFX_CONFIG_DEBUG_OBJECT_NAME=1)
	else()
		target_compile_definitions( bgfx PRIVATE BGFX_CONFIG_DEBUG_OBJECT_NAME=0)
	endif()
endif()
...
if (DEFINED BGFX_CONFIG_RENDERER_DIRECT3D9)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_DIRECT3D9=${BGFX_CONFIG_RENDERER_DIRECT3D9})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_DIRECT3D11)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_DIRECT3D11=${BGFX_CONFIG_RENDERER_DIRECT3D11})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_DIRECT3D12)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_DIRECT3D12=${BGFX_CONFIG_RENDERER_DIRECT3D12})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_GNM)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_GNM=${BGFX_CONFIG_RENDERER_GNM})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_METAL)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_METAL=${BGFX_CONFIG_RENDERER_METAL})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_NVN)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_NVN=${BGFX_CONFIG_RENDERER_NVN})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_OPENGLES)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_OPENGLES=${BGFX_CONFIG_RENDERER_OPENGLES})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_OPENGL)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_OPENGL=${BGFX_CONFIG_RENDERER_OPENGL})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_VULKAN)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_VULKAN=${BGFX_CONFIG_RENDERER_VULKAN})
endif()

if (DEFINED BGFX_CONFIG_RENDERER_WEBGPU)
	target_compile_definitions(bgfx PUBLIC BGFX_CONFIG_RENDERER_WEBGPU=${BGFX_CONFIG_RENDERER_WEBGPU})
endif()
